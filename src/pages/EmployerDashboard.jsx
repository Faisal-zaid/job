      ...
      {jobs.length === 0 ? (
        ...
        jobs.map((job) => (
          ...
          >
            ...
            {/* NEW: Display Applicants under each job */}
            {job.applications && job.applications.length > 0 && (
              <div style={{ marginTop: 15 }}>
                <h5>Applicants:</h5>
                <ul>
                  {job.applications.map((app) => (
                    <li key={app.id} style={{ marginBottom: 10 }}>
                      <strong>{app.applicant_name}</strong> - {app.education}
                      <p style={{ margin: "5px 0" }}>
                        Cover Letter: {app.cover_letter}
                      </p>
                      <p style={{ margin: "5px 0" }}>CV: {app.cv}</p>
                    </li>
                  ))}
                </ul>
              </div>
